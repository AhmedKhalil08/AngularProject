    ...
    this.ɵcmp = ɵɵdefineComponent({
      ...
      consts: () => {
        ...
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG_C__USERS_AMITIS_CO_DESKTOP_ITI_DOTNET_GRADUATION_PROJECT_ANGULAR_PROJECT_ECOMMERCE_CLIENT_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_NG_BOOTSTRAP_CAROUSEL_MJS_0 = goog.getMsg(" Slide {$interpolation} of {$interpolation_1} ", {
            "interpolation": "�0�",
            "interpolation_1": "�1�"
          }, {
            original_code: {
          ...
          i18n_0 = MSG_C__USERS_AMITIS_CO_DESKTOP_ITI_DOTNET_GRADUATION_PROJECT_ANGULAR_PROJECT_ECOMMERCE_CLIENT_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_NG_BOOTSTRAP_CAROUSEL_MJS_0;
        } else {
        ...
        let i18n_1;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG_C__USERS_AMITIS_CO_DESKTOP_ITI_DOTNET_GRADUATION_PROJECT_ANGULAR_PROJECT_ECOMMERCE_CLIENT_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_NG_BOOTSTRAP_CAROUSEL_MJS_1 = goog.getMsg("Previous");
          i18n_1 = MSG_C__USERS_AMITIS_CO_DESKTOP_ITI_DOTNET_GRADUATION_PROJECT_ANGULAR_PROJECT_ECOMMERCE_CLIENT_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_NG_BOOTSTRAP_CAROUSEL_MJS_1;
        } else {
          i18n_1 = $localize`:@@ngb.carousel.previous:Previous`;
        }
        let i18n_2;
        if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
          const MSG_C__USERS_AMITIS_CO_DESKTOP_ITI_DOTNET_GRADUATION_PROJECT_ANGULAR_PROJECT_ECOMMERCE_CLIENT_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_NG_BOOTSTRAP_CAROUSEL_MJS_2 = goog.getMsg("Next");
          i18n_2 = MSG_C__USERS_AMITIS_CO_DESKTOP_ITI_DOTNET_GRADUATION_PROJECT_ANGULAR_PROJECT_ECOMMERCE_CLIENT_NODE_MODULES__NG_BOOTSTRAP_NG_BOOTSTRAP_FESM2022_NG_BOOTSTRAP_NG_BOOTSTRAP_CAROUSEL_MJS_2;
        } else {
...
//# sourceMappingURL=chunk-UBXKHMPP.js.map
